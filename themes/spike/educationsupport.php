    ...
    <div class="col-xs-12 no-padding">
        <div class="assistance-top">
            ...
            <div class="assistence-pic-container">
                <img src="<?php bloginfo('template_url'); ?>/images/assistance/banner_store.png"></div>
    ...
    <div class="col-sm-offset-1 col-sm-10 no-padding">
        <div class="volunteer-stories"><h2 class="middle-title"></h2>
            <div class="row text-center">
                ...
                <?php $category = get_category_by_slug('educationsupport_zh');
                $args = array(
        ...
        <div class="pagination-project">
            <ul class="pagination">
                ...
                <li class=""><a name="1"><!-- react-text: 1460 --> <!-- /react-text --><!-- react-text: 1461 -->1
                        <!-- /react-text --></a></li>
                <li class=""><a name="2"><!-- react-text: 1464 --> <!-- /react-text --><!-- react-text: 1465 -->2
                        <!-- /react-text --></a></li>
                <li class=""><a name="3"><!-- react-text: 1468 --> <!-- /react-text --><!-- react-text: 1469 -->3
                        <!-- /react-text --></a></li>
