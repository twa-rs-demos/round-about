...
<div id="people" class="container-fluid no-padding">
    ...
    <div id="people-volunteer" class="col-xs-offset-3 col-xs-6"><h2 class="middle-title people-h2-title">以人为本，众人为爱</h2>
        ...
        <button type="button" class="button-style become-volunteer center-block" data-toggle="modal" data-target="#volunteers-application-form">
            加入志愿者行列
        </button>
        　
    </div>
    ...
    <div id="ourTeam" class="container">
        ...
        <div class="col-md-offset-1 col-md-10 col-xs-offset-3 col-xs-6">
            <button class="button-style become-volunteer  center-block welcome-family" data-toggle="modal" data-target="#volunteers-application-form">加入众爱大家庭</button>
        </div>
