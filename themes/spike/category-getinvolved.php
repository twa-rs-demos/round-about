      ...
      <div class="get-involved-welcome">
        ...
        <div class="row">
          <div class="col-sm-6 text-left get-involved-item">
            <div class="child"><img src="<?php bloginfo(template_url); ?>/images/getInvolved/icon_volunteer.png"><a href=" http://demo:8080/zh/getinvovled_zh/volunteer_zh/">加入志愿者行列</a></div>
          </div>
          ...
          <div class="col-sm-6 text-left get-involved-item" id="charities">
            <div class="child"><img src="<?php bloginfo(template_url); ?>/images/getInvolved/icon_support.png"><a href="http://demo:8080/zh/getinvovled_zh/classifieds_zh/">合作与支持的慈善机构</a></div>
          </div>
          <div class="col-sm-6 text-left get-involved-item">
            <div class="child"><img src="<?php bloginfo(template_url); ?>/images/getInvolved/icon_donate.png"><a href="http://demo:8080/zh/donate_zh/">捐赠</a></div>
          </div>
          <div>
            <div class="col-sm-6 text-left get-involved-item">
              <div class="child"><img src="<?php bloginfo(template_url); ?>/images/getInvolved/icon_support.png"><a href="http://demo:8080/zh/directory_zh/">您的捐赠可以帮到谁</a></div>
            </div>
            <div class="col-sm-6 text-left get-involved-item" id="communitycenter">
              <div class="child"><img src="<?php bloginfo(template_url); ?>/images/getInvolved/icon_community center.png"><a href="http://demo:8080/zh/communitycenter_zh/">社区中心</a></div>
            </div>
          </div>
        </div>
      </div>
