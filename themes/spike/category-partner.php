                ...
                <div><h2 class="middle-title">众爱与合作伙伴同是一家人</h2>
                    <div class="partners-logo">
                        <div class="row">
                            ...
                            <div class="col-sm-4 text-center"><img class="image-border"
                                                                   src="<?php bloginfo('template_url'); ?>/images/partners/logo_city wise.png" alt="">
                ...
                <div><h2 class="middle-title no-padding">成为我们的合作伙伴</h2>
                    <div class="partner-form">
                        <div class="row margin-bottom">
                            <div class="col-sm-4 col-xs-12"><label class="label-name">First Name</label><input
                                        type="text" class="input-style name form-height"></div>
                            <div class="col-sm-4 col-xs-12"><label class="label-name">Last Name</label><input
                                        type="text" class="input-style name form-height"></div>
                            <div class="col-sm-4 col-xs-12"><label class="label-name">Email Address</label><input
                                        type="text" class="input-style full-width form-height"></div>
                        </div>
                        <div class="row margin-bottom">
                            <div class="col-sm-6 col-xs-12"><label class="label-name">Company Name</label><input
                                        type="text" class="input-style full-width form-height"></div>
                            <div class="col-sm-6 col-xs-12"><label class="label-name">Company Website</label><input
                                        type="text" class="input-style full-width form-height"></div>
                        </div>
                        <div class="row margin-bottom">
                            <div class="col-sm-6 col-xs-12"><select class="input-style full-width form-height">
                        ...
                        <div class="row margin-bottom">
                            <div class="col-sm-12"><label class="label-name">Leave a Message</label><textarea rows="5"
                                                                                                              class="input-style full-width"></textarea>
                            </div>
                        </div>
                        <div class="row margin-bottom">
