            ...
            <div class="top-info">
                <div class="row no-margin">
                    <div class="col-md-6 col-sm-4 col-xs-3">
                        <div class="row logo"><a href="/tw-ra/"><!-- react-text: 8 --> <!-- /react-text --><img
                    ...
                    <div class="col-md-6 col-sm-8 col-xs-9 text-right no-padding">
                        <div class="right-topinfo"><a class="top-right-word  no-padding"
                                                      href="/tw-ra/newsandevent/newslettercenter">月报中心</a><a
                                    href="#apply-monthly-report" class="top-right-word no-padding">月报申领</a><a href="#"
                                                                                                              class="no-padding top-right-word">English</a><a
                                    class="no-padding top-left-icon "><img class="icon"
