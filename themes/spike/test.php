...
<div id="medical-assistance" class="row">
                ...
                <div class="col-sm-offset-1 col-sm-10 no-padding">
                    ...
                    <div class="pagination-project">
                        <ul class="pagination">
                            ...
                            <li class=""><a name="1"><!-- react-text: 117 --> <!-- /react-text --><!-- react-text: 118 -->1
                                    <!-- /react-text --></a></li>
                            <li class=""><a name="2"><!-- react-text: 121 --> <!-- /react-text --><!-- react-text: 122 -->2
                                    <!-- /react-text --></a></li>
                            <li class=""><a name="3"><!-- react-text: 125 --> <!-- /react-text --><!-- react-text: 126 -->3
                                    <!-- /react-text --></a></li>
            ...
            /images/assistance/banner_store.png">
