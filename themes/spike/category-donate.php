    ...
    <div class="container">
            ...
            <div class="donate-guide-apply row">
                <div id="donate-guide-apply-hash"
                    ...
                    <div class="col-sm-offset-4 col-xs-offset-0 col-sm-4 col-xs-12 apply-collect-items">
                        <button class="apply-button js-open-box" data-toggle="modal" data-target="#request-pick-up-for-donations-form">上门收取捐赠物品申请表</button>
                    </div>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">
                                        ...
                                        <span class="form-statement">* Required</span>
                                    </h4>
                                </div>
                                <div class="modal-body">
        ...
        <div class="donating-projects" id="donate-demo">
            ...
            <div class="row">
                ...
                <div class="col-md-1">
                    <div class="text-right pagination-style">
                        <div class="donate-project-more pink">更多&gt;</div>
                    </div>
                </div>
            </div>
        </div>
