    ...
    <div id="donate-page-index">
        ...
        <div class="container">
                                            ...
                                            <a href="http://www.ccafc.org.cn/templates/Donation/txxx.aspx?nodeid=5&amp;projectid=3299&amp;strname=&amp;jiner=&amp;notes_email="
                                               target="_blank">
                                                <div class="image-border">
                                                    <img src="<?php bloginfo('template_url'); ?>/images/logo_ccafc.png"
                                    ...
                                    <div class="row">
                                        <div class="col-xs-offset-1 col-xs-5">
                                            <a href="http://love.alipay.com/donate/itemDetail.htm?name=2015081315541167376" target="_blank">
                                                <img src="<?php bloginfo('template_url'); ?>/images/logo_alipay.png"
                                                     class="img-center">
                                            </a>
                                        ...
                                        <div class="col-xs-5">
                                            <div class="image-border"><img
                                                        src="<?php bloginfo('template_url'); ?>/images/logo_paypal.png"
                                                        class="img-center"></div>
            ...
            <div class="item-donation" id="item-donation">
                ...
                <div class="row">
                    <div class="col-md-offset-1 col-md-10 col-xs-12 donate-collect-items"
                         id="donate-guide-collect-hash">
                ...
                <div class="donate-guide-apply row">
                    <div class="container donate-guide-apply col-xs-12 col-md-offset-1 col-md-10"
                        ...
                        <div class="apply-extra-info"><p>Thank you for requesting a pick up of your donations, we will
                                try
                                our best to help.</p>
                            <p>Please start by filling in the pick up request form. One of our staff will then contact
                                you
                                to make arrangements for the pick up. Please allow 2 business days for us to respond, as
                                we
                                have a small staff.</p>
                            <p>**Due to the nature of Beijing traffic, we cannot guarantee an exact pick-up time. We
                                will
                                strive to arrive within a 1-hour window and call you if our driver is running late.
                                Thank
                                you for giving us as much notice as possible. The more notice you give us, the more
                                likely
