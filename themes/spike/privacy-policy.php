<div id='privacy-policy'>
  ...
  <p class='legal-content'>This privacy policy sets out how “Roundabout” uses and protects any information
    that you give“Roundabout”when
    you use this website.</p>
  <p class='legal-content'>“Roundabout” is committed to ensuring that your privacy is protected. Should we ask
  ...
  <p class='legal-content'>“Roundabout” may change this policy from time to time by updating this page. You
  ...
  <div class='item-sections'>
    <p class='item-title'>what we collect</p>
    <p>We may collect the following information:</p>
    <ul>
      <li class='li-item'>name and job title</li>
      <li class='li-item'>contact information including email address</li>
      <li class='li-item'>demographic information such as postcode, preferences and interests</li>
      <li class='li-item'>other information relevant to donor surveys</li>
    </ul>
  </div>
  <div class='item-sections'>
    <p class='item-title'>What we do with the information we gather</p>
    ...
    <ul>
      <li class='li-item'>Internal record keeping.</li>
      <li class='li-item'>We may use the information to improve our services to charity.</li>
      <li class='li-item'>We may periodically send emails about events, special appeals or other information
        which we think you
        may
  ...
  <div class='item-sections'>
    <p class='item-title'>How we use cookies</p>
    <p class='Legal-content'>A cookie is a small file which asks permission to be placed on your computer’s
    ...
    <p class='legal-content'>We use traffic log cookies to identify which pages are being used. This helps us
    ...
    <p class='legal-content'>Overall, cookies help us provide you with a better website, by enabling us to
  ...
  <div class='item-sections'>
    <p class='item-title'>Links to other websites</p>
    <p class='legal-content'>Our website may contain links to other websites of interest. However, once you
    ...
    <p class='legal-content'>We will not sell, distribute or lease your personal information to third parties
      unless we have your
    ...
    <p class='legal-content'>You may request details of personal information which we hold about you under the
